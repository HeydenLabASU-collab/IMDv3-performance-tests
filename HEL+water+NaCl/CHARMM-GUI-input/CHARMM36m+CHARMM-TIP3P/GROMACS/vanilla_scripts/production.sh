...
for (( i=1; i<=5; i++ )); do
    ...
    # Make sure the directory of the input files are correct!!!
    gmx grompp -f ../../../GROMACS_INPUT/step5_production.mdp -o ${run_folder}/run.tpr -c ../../../GROMACS_INPUT/step4.1_equilibration.gro -p ../../../GROMACS_INPUT/topol.top -n ../../../GROMACS_INPUT/index.ndx
