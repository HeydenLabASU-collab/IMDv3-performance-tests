...
for (( i=1; i<=5; i++ )); do
    ...
    gmx grompp -f ../../../GROMACS_INPUT/step5_production_imdv3.mdp -o ${run_folder}/run.tpr -c ../../../GROMACS_INPUT/step4.1_equilibration.gro -p ../../../GROMACS_INPUT/topol.top -n ../../../GROMACS_INPUT/index.ndx
