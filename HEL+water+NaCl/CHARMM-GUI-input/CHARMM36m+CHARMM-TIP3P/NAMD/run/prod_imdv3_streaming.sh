...
prod_prefix="step5_production_imdv3_streaming"
prod_step="step5_imdv3_streaming"
...
for run in $(seq 1 "$n_runs"); do
    ...
    while [[ $cnt -le $cntmax ]]; do
        ...
        taskset -c "$NAMD_CORES"-$((NAMD_CORES + PYTHON_CORES - 1)) python3.11 input/IMDv3-client.py &
        wait
