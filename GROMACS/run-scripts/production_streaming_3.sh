...
for freq in "${freq_list[@]}"; do
    ...
    mkdir -p performance_streaming_3
    cd performance_streaming_3
    ...
    for (( i=1; i<=5; i++ )); do
        ...
        gmx grompp -f ${input_folder}/step5_production_imdv3_streaming_3_${freq}.mdp -o ${run_folder}/run.tpr -c ${input_folder}/step4.1_equilibration.gro -p ${input_folder}/topol.top -n ${input_folder}/index.ndx
