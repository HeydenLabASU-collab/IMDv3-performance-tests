...
#SBATCH --job-name=namd-mpi-smp-resident
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=4
#SBATCH -G a100:1
#SBATCH --time=00:20:00
#SBATCH --output=namd_smp_resident_%j.out
...
BIN_DIR="$PWD/../bin"
EXEC_NAME="namd_mpi_smp_gpuresident_${VERSION}"

# Clean up old build
BUILD_DIR="$PWD/../bin/build-mpi-smp-gpu-resident"
rm -rf "$BUILD_DIR"
