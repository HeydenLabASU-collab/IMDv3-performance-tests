...
# LAMMPS IMDv3 optimization script.
# Usage: ./run_imdv3_lammps.sh <n_cores> <gpu_device> <n_runs> <typeprod> <COMMON_LOG> <exec_name> <use_gpu> <input_file>

# Input parameters (Kokkos only)
...
opt_prefix="step_opt_imdv3"
lammps="$EXEC_NAME"
config_label="${USE_GPU}-0-${N_CORES}"
output_dir="output/imdv3/${TYPEPROD}/prod/${config_label}"
...
for run in $(seq 1 "$N_RUNS"); do
    echo "=========================================="
    echo "Running IMDv3 optimization: config=$config_label, run=$run"
    echo "=========================================="
    ...
    input_file="input/${opt_prefix}_imdv3_${config_label}_run${run}.in"
...
echo "=========================================="
echo "IMDv3 Kokkos optimization complete for config=$config_label"
echo "=========================================="
